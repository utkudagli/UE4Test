...
#include "InfoWidget3.generated.h"

/**
 * 
 */
UCLASS()
class SQUAREBYTESTEST_API UInfoWidget3 : public UUserWidget
{
	GENERATED_BODY()
private:
...
public:
	...
	ASquareBytesTestProjectile* Proj = Cast<ASquareBytesTestProjectile>(this->GetClass());
